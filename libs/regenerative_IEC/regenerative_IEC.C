...
regenerative_IEC::regenerative_IEC (const char *path): IEC(path)
{}
	
//////////// public functions /////////////////////

void regenerative_IEC::solve()
{
	int i, j, iteration = 0;
	...
	do {
        ...
        for (j=0;j<numberOfNodes;j++)
        {
            ...
            T_secondaryAir[0][j] = T_primaryAir[numberOfNodes-1][j];
...
void regenerative_IEC::setBoundaryConditions()
{
